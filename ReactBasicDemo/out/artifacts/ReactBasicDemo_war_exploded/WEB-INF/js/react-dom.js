...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('web/WEB-INF/js/react')) :
	typeof define === 'function' && define.amd ? define(['web/WEB-INF/js/react'], factory) :
...
// can be mutated and processed asynchronously before it is committed 鈥� a form
...
function enqueueUpdate(fiber, update, expirationTime) {
  ...
  if (queue2 === null || queue1 === queue2) {
    ...
    // while accounting for the persistent structure of the list 鈥� we don't
...
/**
 * The "base" render time is the duration of the 鈥渂egin鈥� phase of work for a particular fiber.
  ...
  if (mixedRef !== null && typeof mixedRef !== 'function' && typeof mixedRef !== 'object') {
    {
      if (returnFiber.mode & StrictMode) {
        ...
        if (!didWarnAboutStringRefInStrictMode[componentName]) {
          warning_1(false, 'A string ref, "%s",聽has been found within a strict mode tree. ' + 'String refs are a source of potential bugs and should be avoided. ' + 'We recommend using createRef() instead.' + '\n%s' + '\n\nLearn more about using refs safely here:' + '\nhttps://fb.me/react-strict-mode-string-ref', mixedRef, getStackAddendumByWorkInProgressFiber(returnFiber));
